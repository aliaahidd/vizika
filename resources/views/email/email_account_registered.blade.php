...
<p>Website Link: <a href="https://vizika.online/register-external-user?name={{ urlencode($data['name']) }}&email={{ urlencode($data['email']) }}&category={{ urlencode($data['category'])}}">Click here</a></p>
