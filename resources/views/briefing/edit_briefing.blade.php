...
<div class="card">
    <div class="card-body">
        ...
        <form method="POST" action="{{ route('updatebriefinginfodata', $safetybriefinginfo->id) }}" enctype="multipart/form-data" id="briefing">
            @csrf
            <div class="row mb-3">
                <div class="col-md-6 mb-3">
                    <label>Date<span style="color: red; margin-left: 5px">*</span></label>
                    <input type="date" name="briefingDate" class="form-control" id="txtDate" value="{{ $safetybriefinginfo->briefingDate }}" required>
                    <br>
                    <label>Time end<span style="color: red; margin-left: 5px">*</span></label>
                    <input type="time" name="briefingTimeEnd" class="form-control" id="endTimeInput" value="{{ $safetybriefinginfo->briefingTimeEnd }}" required>
                </div>

                <div class="col-md-6">
                    <label>Time Start<span style="color: red; margin-left: 5px">*</span></label>
                    <input type="time" name="briefingTimeStart" class="form-control" id="timeInput" value="{{ $safetybriefinginfo->briefingTimeStart }}" required>
                    <br>
                    <label>Max Participant<span style="color: red; margin-left: 5px">*</span></label>
                    <input type="number" name="participantNo" class="form-control" placeholder="Ex: 30" value="{{ $safetybriefinginfo->maxParticipant }}" required>
                </div>
            </div>
